      ...
      >
         <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-orange-500/20 to-orange-400/20 rounded-xl mb-4 border border-orange-500/60"
            >
              <UserPlus className="text-orange-500" size={28} />
            </motion.div>
            <h2 className="text-3xl font-bold text-[#e8ecf1] mb-2">Create Account</h2>
            <p className="text-[#cbd5e1]">Join and start building your AI-powered resume.</p>
         </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
           ...
           <div>
             ...
             <div className="relative">
               ...
               <input 
                 ...
                 onChange={(e) => setPassword(e.target.value)}
                  className="w-full px-4 py-3 pl-10 rounded-lg bg-[#1a202c] border border-orange-400/30 text-[#e8ecf1] placeholder-[#64748b] focus:border-orange-400 focus:ring-2 focus:ring-orange-400/20 outline-none transition-all"
                 placeholder="••••••••"
                 required 
               />
             </div>
            ...
            <motion.button 
              ...
              type="submit"
              disabled={loading}
              className={`w-full py-3 ${loading ? 'bg-orange-500/60' : 'bg-gradient-to-r from-orange-500 to-orange-400 hover:shadow-lg hover:shadow-orange-500/70'} text-black font-bold rounded-lg transition-all flex justify-center items-center gap-2`}
            >
             {loading ? (
               <>
          ...
          <div className="mt-6 text-center">
            <p className="text-[#cbd5e1]">
              ...
              <Link to="/login" className="text-orange-400 font-semibold hover:text-orange-500 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
